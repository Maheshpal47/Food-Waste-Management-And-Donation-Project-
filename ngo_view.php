...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="ngo_view1.css">
</head>
<body id="ngoview">
   ...
   <div class="container mt-5">
        ...
        <?php foreach($query as $q){?>
          ...
          <div class="pv bg-dark p-5 rounded-lg text-light text-center">
                <h1 class="restname">NGO Name : <?php echo $q['ngoname'];?></h1>
                 <h1 class="dat">Date : <?php echo $q['datep'];?></h1>
                 <h1 class="pincode">Pincode :<?php echo $q['pin'];?></h1>
        ...
        <div class="text-center">
                    <a href="NGO_home.php" class="btn btn-outline-dark my-3" >Go Home</a>
